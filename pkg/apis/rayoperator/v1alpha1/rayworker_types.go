...
// RayWorkerStatus defines the observed state of RayWorker
// +k8s:openapi-gen=true
type RayWorkerStatus struct {
...
type RayWorker struct {
	...
	Spec   RayWorkerSpec   `json:"spec,omitempty"`
	Status RayWorkerStatus `json:"status,omitempty"`
}
